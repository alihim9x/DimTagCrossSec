...
namespace SingleData
{
    public class RevitData
    {
        ...
        private Document revitLinkDocument;
        public Document RevitLinkDocument
        {
            get
            {
                if(revitLinkDocument == null)
                {
                    revitLinkDocument = ModelData.Instance.Setting.RevitLink?.GetLinkDocument();
                }
                return revitLinkDocument;
            }
        }
        ...
        //    }
        //}
        private IEnumerable<RevitLinkInstance> revitLinks;
        public IEnumerable<RevitLinkInstance> RevitLinks
        {
            get
            {
                
                {
                    revitLinks = new FilteredElementCollector(Document).OfCategory(BuiltInCategory.OST_RvtLinks).WhereElementIsNotElementType().Cast<RevitLinkInstance>();
                }
                return revitLinks;
            }
        }
        ...
        private IEnumerable<FamilyInstance> familyInstancesInViewRvL;
        public virtual IEnumerable<FamilyInstance> FamilyInstancesInViewRvL
        {
            get
            {
                if(familyInstancesInViewRvL == null && InstanceElementsInViewRvL != null)
                {
                    familyInstancesInViewRvL = InstanceElementsInViewRvL.Where(x => x is FamilyInstance).Cast<FamilyInstance>();
                }
                return familyInstancesInViewRvL;
            }
        }
        ...
        public virtual IEnumerable<IndependentTag> IndependentTags
        {
            get
            {
                ...
                {
                    independentTags = InstanceElements.Where(x => x.Category.Id.IntegerValue == (int)BuiltInCategory.OST_RebarTags).Cast<IndependentTag>();
                }
        ...
        private IEnumerable<Element> instanceElementsInViewRvL;
        ...
        private IEnumerable<Rebar> rebarInstancesInViewRvL;
        public virtual IEnumerable<Rebar> RebarInstancesInViewRvL
        {
            get
            {
                if (rebarInstancesInViewRvL == null && InstanceElementsInViewRvL != null)
                {
                    rebarInstancesInViewRvL = InstanceElementsInViewRvL.Where(x => x is Rebar).Cast<Rebar>();
                }
                return rebarInstancesInViewRvL;
            }
        }
        ...
        private IEnumerable<FamilyInstance> framingInstancesInViewRvL;
        public virtual IEnumerable<FamilyInstance> FramingInstancesInViewRvL
        {
            get
            {
                if(framingInstancesInViewRvL == null && FamilyInstancesInViewRvL != null)
                {
                    framingInstancesInViewRvL = FamilyInstancesInViewRvL.Where(x => x.Category.Id.IntegerValue == (int)BuiltInCategory.OST_StructuralFraming);
                }
                return framingInstancesInViewRvL;
            }
        }
        ...
        private IEnumerable<Floor> floorInstancesInViewRvL;
        public virtual IEnumerable<Floor> FloorInstancesInViewRvL
        {
            get
            {
                if(floorInstancesInViewRvL == null && InstanceElementsInViewRvL != null)
                {
                    floorInstancesInViewRvL = InstanceElementsInViewRvL.Where(x => x is Floor).Cast<Floor>();
                }
                return floorInstancesInViewRvL;
            }
        }
